...
def main():
    ...
    # 源文件路径
    source_file = '/home/lddc/SHENYANLONG/live555/testProgs/output_'+args.SUT+'/fuzzer_stats'
    # 目标文件夹路径
    current_time = time.strftime('%Y%m%d_%H')
    destination_folder = '/home/lddc/SHENYANLONG/fuzz_stats/'+args.SUT+'fuzz_stats_'+current_time
